                        ...
                        <Col lg='12'>
                            {
                                ...
                                © 2024 Team  <Image src={teamLogo}  style={{width :"120px" }}/> . All rights reserved.
                                    </p>
                                )
                            }
                            {
                                i18n.language === 'ar' && (
                                    <p className='text-center'>
                                        © 2024 الفريق <Image src={teamLogo}  style={{width :"120px" }}/> كل الحقوق محفوظة.
                                    </p>
                                )
                            }
