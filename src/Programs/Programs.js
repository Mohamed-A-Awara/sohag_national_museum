    ...
    return (
        ...
        {/* //////////////////////////////////section2////////////////////////////////////  */}
            ...
            <section className='sec2'>
                <div className='top'>
                    <div className='text'>
                        <p>Implementing the museum sector’s plan aimed at holding temporary annual exhibitions in each museum</p>
                        <p>Renewing the museum display through these temporary exhibitions to provide a renewed view of the museum to attract visitors. It also serves as a window for the stored artifacts to see the light through these exhibitions,
                ...
                <div className='text'>
                    <p>Continuous training for museum curators on museum display, writing archaeological and historical proposals,
                            display cards, and selecting artifacts that serve the topics.</p>
                    <p>Informing visitors that our antiquities are the subject of the world’s admiration and talk, 
                ...
                <div className='text'>
                    <p>Maximizing the societal role of the museum through these exhibitions to increase archaeological awareness and introduce cultural heritage through seminars, lectures and workshops 
                        that will be held on the sidelines of the exhibition during the three-month life of the exhibition.</p>
                </div>
                    <div className='image'>
                    <img src={img3}/>
                    </div>
