...
import BtnReadMore from '../Halls/BtnReadMore'
import './Programs.css'
import '../Halls/BtnReadMore.css'
...
function Programs() {
    return (
        ...
        <>
            ...
            <section className='sec1'>
                ...
                <p className='sec1_p3'>Achievements of Sohag National Museum 2022 </p>
            </section>
        {/* //////////////////////////////////section2////////////////////////////////////  */}
            <div className='head_section'>
                    <p>Exhibitions</p>
            ...
            <section className='sec2'>
                <div className='top'>
                    <div className='text'>
                        ...
                        <BtnReadMore content="Renewing the museum display through these temporary exhibitions to provide a renewed view of the museum to attract visitors. It also serves as a window for the stored artifacts to see the light through these exhibitions,
                                as well as linking the artifacts to national events and local and international occasions." /></p>
                ...
                <div className='text'>
                    <p>Continuous training for museum curators on museum display, writing archaeological and historical proposals,
                        ...
                        and it is our duty to preserve them in order to hand them over to those after us, just as we received them before us."/></p>
                </div>
                    <div className='image'>
                    <Image src={img2}/>
                    </div>
                ...
                <div className='text'>
                    <p>Maximizing the societal role of the museum through these exhibitions to increase archaeological awareness 
                    <BtnReadMore content= "and introduce cultural heritage through seminars, lectures and workshops that will be held on the sidelines of the exhibition during the three-month life of the exhibition."/></p>
                </div>
                    <div className='image'>
                    <Image src={img3}/>
                    </div>
        ...
        <div className='text-before-sec'>
            <p className='sec1_p1'>Highlighting the role of museums as enlightening and educational institutions by linking the museum to society in all its categories and by participating in all local and international events.
            <BtnReadMore content= "This is done by participating in a group of technical and educational workshops and educational lectures for all groups, students of all educational levels, and university students."/></p>
        </div>
    ...
    {/* ///////////////////////////////////////section4//////////////////////////////////////////////////////////////////////////////////////// */}
        ...
        <div className='text-before-sec'>
            <p className='sec1_p1'>Many workshops, entertainment activities and lectures were held
                    Through it<BtnReadMore content= ", people of determination are integrated into the museum,and attention is paid to providing all means of safety. Special badges have been placed and the museum is prepared to receive them."/></p>
        </div>
    ...
    {/* ///////////////////////////////////////section5//////////////////////////////////////////////////////////////////////////////////////// */}
        ...
        <div className='text-before-sec'>
            <p className='sec1_p1'>Providing training programs for university students in the departments of Egyptian antiquities<BtnReadMore content= ", Islamic antiquities, and restoration departments, to introduce the role of museums in society, to increase archaeological awareness, to introduce museum management and management of museum collections, to give trainees an idea of the role and importance of the museum in society, the origin and development of museums, and an explanation of museum holdings, management of museum collections, temporary exhibitions, the role of museum trustees, and tours.Internal and external, as well as the role of the restoration department As well as lectures for archaeological field workers from various sectors."/></p>
        </div>
