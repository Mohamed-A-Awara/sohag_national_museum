            ...
            <div className='halls-text pt-3 pb-3'>
                    <Container>
                        <ul>
                            ...
                            <li><span style={{fontSize :"20px" , fontWeight : "700"}}>First Showcase : </span> <br/> <br/>The showcase contains artifacts representing the cohesion of Egyptian families. A limestone panel depicts a man with his son in front of them, offering a table of offerings with various foods.
                                <BtnReadMore content="In the scene, the man's wife and behind her, their daughter are also depicted. Additionally, there is a statue of a person named 'Antef' and his wife found in Abydos, resembling a commemorative image of a man and his wife. There is also a terracotta statue of a woman breastfeeding her child and other pieces representing children's toys, including terracotta figurines, dice, and some balls used for play."/>
                            </li>
                            ...
                            <li> <span style={{fontSize :"20px" , fontWeight : "700"}}>Third Showcase : </span> <br/> <br/>This showcase contains a diverse collection of jewelry that women used to enhance their beauty, including bracelets made of ivory, bone, bronze, and others. There are also necklaces made of precious and semi-precious stones, with some featuring amulets or charms.</li>
                        </ul>
                    </Container>
                </div>
