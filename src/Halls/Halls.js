...
import Second_Hall from './Second-Hall';
import Third_Hall from './Third-Hall';
import Fourth_Hall from './Fourth-Hall';
import Fifth_Hall from './Fifth-Hall';
import Sixth_Hall from './Sixth-Hall';
        ...
        <>
            <section className='halls-style'>
                <div className='full-back'>
                    <Container>
                        <h2 className='p-3 halls-h2'>Halls of Sohag National Museum  </h2>
                    </Container>
                </div>
                ...
                <div className='halls-text pt-3 pb-3'>
                    <Container>
                        <ul className='Sixth-list'>
                            ...
                            <li>The main floor, which serves as the primary entrance, is home to six halls. Three of these halls are situated to the north, facing their counterparts to the south. Among them is the grand exhibition hall, a centerpiece that showcases remarkable artifacts and exhibits.</li>
                            <li>Ascending the stairs to the right of the entrance takes visitors to the second floor. Here, a dedicated space is reserved for temporary exhibitions, specifically designed to host four archaeological exhibitions throughout the year. This area promises an ever-changing display of antique pieces, providing visitors with a dynamic and enriching experience.</li>
                            <li>The lower floor, on the other hand, boasts a spacious exhibition hall that is intricately divided into four corridors known as the “Other World Hall.” Each corridor presents a unique perspective and theme, contributing to the museum's comprehensive exploration of diverse historical and cultural narratives.</li>
                ...
                <div className='first-halls full-back'>
                    <Container>
                        <h2 className='p-3 halls-h2'>The First Hall : Hall of Kings and Important Ministers </h2>
                    </Container>     
                </div>
                ...
                <div className='first-halls full-back'>
                    <Container>
                        <h2 className='p-3 halls-h2'>The Second Hall : Family and Social Life </h2>
                    </Container>     
                </div>
                ...
                <div className='first-halls full-back'>
                    <Container>
                        <h2 className='p-3 halls-h2'>The Third Hall : Ancient Egyptian Cuisine</h2>
                    </Container>     
                </div>
                ...
                <div className='first-halls full-back'>
                    <Container>
                        <h2 className='p-3 halls-h2'>The Fourth Hall: Hall of Crafts and Industries</h2>
                    </Container>     
                </div>
                ...
                <div className='first-halls full-back'>
                    <Container>
                        <h2 className='p-3 halls-h2'>The Fifth Hall : Textile Exhibition</h2>
                    </Container>     
                </div>
                ...
                <div className='first-halls full-back'>
                    <Container>
                        <h2 className='p-3 halls-h2'>The Sixth Hall : Heritage</h2>
                    </Container>     
                </div>
