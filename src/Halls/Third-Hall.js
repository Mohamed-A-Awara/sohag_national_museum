        ...
        <>
            <div className='halls-text pt-3 pb-3'>
                    <Container>
                        <ul>
                            <li>
                                Within these exhibits lies an extensive collection of culinary tools and utensils crafted from an array of materials, including alabaster, granite, basalt, and pottery. The varied sizes and shapes of these items hint at their manifold applications in the culinary practices of ancient Egyptians.
                                <BtnReadMore
